...
class ReliabilityChecker:
    ...
    def check_resource(self, resource_name: str) -> ResourceHealth:
        ...
        if "cluster" in normalized_name or "eks" in normalized_name:
        ...
        if "rds" in normalized_name or "db" in normalized_name:
            return ResourceHealth(
                resource_name=resource_name,
        ...
        if "terraform" in normalized_name or "tfstate" in normalized_name:
            return ResourceHealth(
                resource_name=resource_name,
